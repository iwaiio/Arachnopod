...
#define PSSPWR                             0      /** PSS вкл/выкл                                                                        */
#define PSSPWR12                           1      /** питание контура 12V                                                                 */
#define PSSPWR6                            2      /** питание контура 6V                                                                  */
#define PSSPWR5                            3      /** питание контура 5V                                                                  */
#define PSSPWR33                           4      /** питание контура 3.3V                                                                */
#define PSSECO                             5      /** режим экономии энергии                                                              */
#define PSSCLOCK                           6      /** счетчик PSS                                                                         */
#define PSSMAXT1                           7      /** макс температура контура 1                                                          */
#define PSSMAXT2                           8      /** макс температура контура 2                                                          */
#define PSSMAXA                            9      /** макс сила тока A батареи                                                            */
#define PSSMAXW                            10     /** макс мощность W батареи                                                             */
#define PSSMINC                            11     /** мин заряд C батареи                                                                 */
#define PSSMINV                            12     /** мин напряжение V батареи                                                            */
...
#define PSSW                               20     /** мощность W батареи                                                                  */
#define PSSV                               21     /** напряжение V батареи                                                                */
#define PSSC                               22     /** заряд C батареи                                                                     */
#define PSSA12                             23     /** сила тока контура 12V                                                               */
#define PSSV12                             24     /** напряжение контура 12V                                                              */
#define PSSA6                              25     /** сила тока контура 6V                                                                */
#define PSSV6                              26     /** напряжение контура 6V                                                               */
#define PSSA5                              27     /** сила тока контура 5V                                                                */
#define PSSV5                              28     /** напряжение контура 5V                                                               */
#define PSSA33                             29     /** сила тока контура 3.3V                                                              */
#define PSSV33                             30     /** напряжение контура 3.3V                                                             */
#define TCSPWR                             31     /** TCS вкл/выкл                                                                        */
#define TCSPSS                             32     /** опрос PSS                                                                           */
#define TCSTMS                             33     /** опрос TMS                                                                           */
#define TCSMNS                             34     /** опрос MNS                                                                           */
#define TCSLS                              35     /** опрос LS                                                                            */
#define TCSCLOCK                           36     /** счетчик TCS                                                                         */
#define TCSFRQ                             37     /** скорость опроса систем                                                              */
#define TCST                               38     /** температура TCS                                                                     */
#define TMSPWR                             39     /** TMS вкл/выкл                                                                        */
#define TMSCLOCK                           40     /** счетчик TMS                                                                         */
#define TMSPWRFAN1                         41     /** питание кулера 1                                                                    */
#define TMSPWRFAN2                         42     /** питание кулера 2                                                                    */
#define TMSPWRFAN3                         43     /** питание кулера 3                                                                    */
#define TMSPWRFAN4                         44     /** питание кулера 4                                                                    */
#define TMST                               45     /** температура TMS                                                                     */
#define MNSPWR                             46     /** TMS вкл/выкл                                                                        */
#define MNSCLOCK                           47     /** счетчик MNS                                                                         */
#define MNST                               48     /** температура MNS                                                                     */
#define LSPWR                              49     /** LS вкл/выкл                                                                         */
